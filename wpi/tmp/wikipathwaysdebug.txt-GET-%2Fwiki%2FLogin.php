...
Start request GET /wiki/Login.php
HTTP HEADERS:
REFERER: http://vm1.wikipathways.org/wiki/login.php
...
Title::getRestrictionTypes: applicable restrictions to [[Login.php]] are {create}
